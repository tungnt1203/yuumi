...
"existing_code" là các dòng code HIỆN CÓ trong file mới từ "line" đến "end_line" (hoặc chỉ dòng "line"), chép nguyên văn từ diff nhưng bỏ ký tự "+"/" " ở đầu mỗi dòng diff. Bot dùng nó để tìm lại đúng vị trí nếu số dòng lệch; đoạn không có trong diff thì finding không được gắn vào dòng. Để rỗng nếu là nhận xét tổng quát.
